...
def amcnet(num_classes:int, sig_size:int):
    model = AMC_Net(num_classes=num_classes, sig_size=sig_size, extend_channel=36, latent_dim=512, num_heads=2, conv_chan_list=[36, 64, 128, 256])
    return model
